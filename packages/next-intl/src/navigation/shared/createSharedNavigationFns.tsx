...
>(
  ...
  type LinkProps<Pathname extends keyof AppPathnames = never> = Prettify<
    ...
    > & {
      /** @see https://next-optimal-intl.dev/docs/routing/navigation#link */
    ...
    : AppLocalePrefixMode extends 'as-needed'
      ? [AppDomains] extends [never]
        ...
        : {
             ...
             * @see https://next-optimal-intl.dev/docs/routing/navigation#getpathname
             */
  ...
  function getRedirectFn(
    ...
    /** @see https://next-optimal-intl.dev/docs/routing/navigation#redirect */
