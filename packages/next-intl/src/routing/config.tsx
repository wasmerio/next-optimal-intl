...
> = {
   ...
   * @see https://next-optimal-intl.dev/docs/routing
   */
  locales: AppLocales;
   ...
   * @see https://next-optimal-intl.dev/docs/routing#locale-prefix
   **/
  localePrefix?: LocalePrefix<AppLocales, AppLocalePrefixMode>;

  /**
   * Can be used to change the locale handling per domain.
   * @see https://next-optimal-intl.dev/docs/routing#domains
   **/
  domains?: AppDomains;

  /**
   * Can be used to disable the locale cookie or to customize it.
   * @see https://next-optimal-intl.dev/docs/routing/middleware#locale-cookie
   */
  localeCookie?: boolean | CookieAttributes;

  /**
   * Sets the `Link` response header to notify search engines about content in other languages (defaults to `true`). See https://developers.google.com/search/docs/specialty/international/localized-versions#http
   * @see https://next-optimal-intl.dev/docs/routing/middleware#alternate-links
   **/
   ...
   * @see https://next-optimal-intl.dev/docs/routing/middleware#locale-detection
   **/
  ...
  : {
       ...
       * @see https://next-optimal-intl.dev/docs/routing#pathnames
       **/
