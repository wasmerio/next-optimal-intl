...
## [6.0.1](https://github.com/amannn/next-optimal-intl/compare/v6.0.0...v6.0.1) (2025-02-26)

**Note:** Version bump only for package next-optimal-intl
...
* `createNavigation` ([#1316](https://github.com/amannn/next-optimal-intl/issues/1316)) ([126013b](https://github.com/amannn/next-optimal-intl/commit/126013b4762a13c8f2375570af7d3c68a12dd3b8)), closes [#444](https://github.com/amannn/next-optimal-intl/issues/444) [#1335](https://github.com/amannn/next-optimal-intl/issues/1335) [#1322](https://github.com/amannn/next-optimal-intl/issues/1322) [#1375](https://github.com/amannn/next-optimal-intl/issues/1375)
* `next-intl@3.0` ([#149](https://github.com/amannn/next-optimal-intl/issues/149)) ([50cf6bb](https://github.com/amannn/next-optimal-intl/commit/50cf6bb41450f32623e2c66569eb1811d7ced336)), closes [#488](https://github.com/amannn/next-optimal-intl/issues/488)
* Accept `locale` with `useRouter` APIs ([#409](https://github.com/amannn/next-optimal-intl/issues/409)) ([0fbb3c7](https://github.com/amannn/next-optimal-intl/commit/0fbb3c7cc9945eff40fe84ef433da172b909a8e6)), closes [#408](https://github.com/amannn/next-optimal-intl/issues/408) [#407](https://github.com/amannn/next-optimal-intl/issues/407) [#320](https://github.com/amannn/next-optimal-intl/issues/320)
* Add `defineRouting` for easier i18n routing setup ([#1299](https://github.com/amannn/next-optimal-intl/issues/1299)) ([5ff6120](https://github.com/amannn/next-optimal-intl/commit/5ff6120d5601e69dbeebd225e7a1416f3701ddc2))
* Add `format.dateTimeRange` ([#769](https://github.com/amannn/next-optimal-intl/issues/769) by [@martinmunillas](https://github.com/martinmunillas)) ([9f12521](https://github.com/amannn/next-optimal-intl/commit/9f12521edecf1aeff40a49ce0c133c19bafa7cf5))
* Add `format.list(…)` for formatting conjunctions and disjunctions ([#327](https://github.com/amannn/next-optimal-intl/issues/327) by [@stefanprobst](https://github.com/stefanprobst)) ([32cda32](https://github.com/amannn/next-optimal-intl/commit/32cda32f47112915bb2032f3f9cc02bf3a4e833b))
* Add `localeCookie` option for middleware ([#1414](https://github.com/amannn/next-optimal-intl/issues/1414)) ([0e984bd](https://github.com/amannn/next-optimal-intl/commit/0e984bd2c901fd1da4ffef2d8d08cb4c924cf6ab))
* Add `localePrefix: 'never'` option for middleware ([#388](https://github.com/amannn/next-optimal-intl/issues/388) by [@boris-arkenaar](https://github.com/boris-arkenaar)) ([92ec33a](https://github.com/amannn/next-optimal-intl/commit/92ec33a8c47929f0ef0902d60bd1f55b64b2cf91)), closes [#366](https://github.com/amannn/next-optimal-intl/issues/366)
* Add `localePrefix` for navigation APIs for an improved initial render of `Link` when using `localePrefix: never`. Also fix edge case in middleware when using localized pathnames for redirects that remove a locale prefix (fixes an infinite loop). ([#678](https://github.com/amannn/next-optimal-intl/issues/678)) ([1c68e3b](https://github.com/amannn/next-optimal-intl/commit/1c68e3b549e2029cbae62d549f609e1d76ca6490)), closes [#444](https://github.com/amannn/next-optimal-intl/issues/444)
* Add `t.has` to check whether a given message exists ([#1399](https://github.com/amannn/next-optimal-intl/issues/1399)) ([ee1a2a9](https://github.com/amannn/next-optimal-intl/commit/ee1a2a94b62474a5d8a1d39c8ff39bec072c02a0))
* Add `useMessages` for convenience and restructure docs to be App Router-first ([#345](https://github.com/amannn/next-optimal-intl/issues/345)) ([0dedbfd](https://github.com/amannn/next-optimal-intl/commit/0dedbfd10411796c7a290f172ad03f406c7cccec))
* Add async `requestLocale` param to `getRequestConfig` for Next.js 15 support ([#1383](https://github.com/amannn/next-optimal-intl/issues/1383)) ([352ddc7](https://github.com/amannn/next-optimal-intl/commit/352ddc79e5e223d5ac6251601bd6ca6862d39670)), closes [/next-intl-docs-git-feat-async-request-locale-next-intl.vercel.app/docs/getting-started/app-router/with-i18n-routing#i18](https://github.com/amannn//next-intl-docs-git-feat-async-request-locale-next-intl.vercel.app/docs/getting-started/app-router/with-i18n-routing/issues/i18)
* Add navigation APIs for App Router (`useRouter`, `usePathname` and `Link`) ([#282](https://github.com/amannn/next-optimal-intl/issues/282)) ([e30a89b](https://github.com/amannn/next-optimal-intl/commit/e30a89b7079d31cfdefdd1a2d0c0a750adf3a6ce))
* Add Next.js 15 to peer dependencies ([#1443](https://github.com/amannn/next-optimal-intl/issues/1443)) ([4cb22bb](https://github.com/amannn/next-optimal-intl/commit/4cb22bb10990961dba7e5accd2b5c70664f2b6d2))
* Add redirects for case mismatches in locale prefixes (e.g. `/EN` → `/en`) ([#861](https://github.com/amannn/next-optimal-intl/issues/861)) ([3b2b446](https://github.com/amannn/next-optimal-intl/commit/3b2b446a241ce2cd402181afb0398565ac4a2492))
* Add support for `basePath` in middleware and navigation APIs ([#699](https://github.com/amannn/next-optimal-intl/issues/699) by @Robjam and [@amannn](https://github.com/amannn)) ([f670f1b](https://github.com/amannn/next-optimal-intl/commit/f670f1b37d803c7fbb6fbaa1c8d10f88cf141a84))
* Add support for `permanentRedirect`in navigation APIs ([#850](https://github.com/amannn/next-optimal-intl/issues/850) by [@polvallverdu](https://github.com/polvallverdu)) ([6508ddc](https://github.com/amannn/next-optimal-intl/commit/6508ddc35ecc95f6dce8b95ecde2734a169579b8))
* Add support for custom prefixes for i18n routing ([#1086](https://github.com/amannn/next-optimal-intl/issues/1086)) ([4ba921a](https://github.com/amannn/next-optimal-intl/commit/4ba921ac5c513d65c81343db3805c8e48da7c3f4))
* Add support for React 19 RC ([#1490](https://github.com/amannn/next-optimal-intl/issues/1490)) ([2dea022](https://github.com/amannn/next-optimal-intl/commit/2dea02271f79e183dfd18a3c77112a79e1fce581))
* Add support for using `next-intl` in the `app` folder with Next.js 13 (see https://next-intl-docs.vercel.app/docs/next-13, [#144](https://github.com/amannn/next-optimal-intl/issues/144)) ([18c94d6](https://github.com/amannn/next-optimal-intl/commit/18c94d623a05afa7710fea83360f12f9811fb38d))
* Add type exports to enable `declaration: true` in `tsconfig.json` ([#1509](https://github.com/amannn/next-optimal-intl/issues/1509)) ([6b2ca9c](https://github.com/amannn/next-optimal-intl/commit/6b2ca9cfddcf8611893f76f9690e0bafb534e8fd))
* Allow optimal routing ([b43cdf2](https://github.com/amannn/next-optimal-intl/commit/b43cdf2b1491dc4c5bb98b02a5b01db90df93c83))
* Automatically prefer localized pathnames that are more specific ([#983](https://github.com/amannn/next-optimal-intl/issues/983) by [@fkapsahili](https://github.com/fkapsahili)) ([88a9b7a](https://github.com/amannn/next-optimal-intl/commit/88a9b7a18e89c4c642c2dd486ad4cb8de24e0086))
* Cache `Intl.*` constructors ([#1193](https://github.com/amannn/next-optimal-intl/issues/1193)) ([52c4f2c](https://github.com/amannn/next-optimal-intl/commit/52c4f2cede844c0ff3d2f73890dcfd75210bc1f2)), closes [#215](https://github.com/amannn/next-optimal-intl/issues/215)
* Experimental support for `--turbo` (requires `next@^14.0.3`) ([#641](https://github.com/amannn/next-optimal-intl/issues/641)) ([46c6ec7](https://github.com/amannn/next-optimal-intl/commit/46c6ec751651ac6d827fec6544a26d3abd5bb70a)), closes [#250](https://github.com/amannn/next-optimal-intl/issues/250)
* Global formatters ([#14](https://github.com/amannn/next-optimal-intl/issues/14)) ([ffe9957](https://github.com/amannn/next-optimal-intl/commit/ffe995734546e7f6774dc737a9d3f121242a7caf))
* Invoke `notFound()` when no locale was attached to the request and update docs to suggest validating the locale in `i18n.ts` ([#742](https://github.com/amannn/next-optimal-intl/issues/742)) ([e6d9878](https://github.com/amannn/next-optimal-intl/commit/e6d98787ad43aec50dcb6594353da83a958a81d1)), closes [#736](https://github.com/amannn/next-optimal-intl/issues/736) [#716](https://github.com/amannn/next-optimal-intl/issues/716) [/next-intl-docs.vercel.app/docs/usage/configuration#i18](https://github.com/amannn//next-intl-docs.vercel.app/docs/usage/configuration/issues/i18)
* Make options for `createSharedPathnamesNavigation` along with `locales` argument optional (relevant when `locales` aren't known statically) ([#784](https://github.com/amannn/next-optimal-intl/issues/784)) ([614053d](https://github.com/amannn/next-optimal-intl/commit/614053ddb40f83f7f4a122e5ffeb836d1ecbf63e))
* Mark `setRequestLocale` as stable ([#1437](https://github.com/amannn/next-optimal-intl/issues/1437)) ([7b3a9a3](https://github.com/amannn/next-optimal-intl/commit/7b3a9a3517f7ec3b196d6eb753a9389734c0a88f))
* Next.js 13 compatibility ([#140](https://github.com/amannn/next-optimal-intl/issues/140)) ([65326a0](https://github.com/amannn/next-optimal-intl/commit/65326a0b47980f260df466a283a6e7a0aa5e1cd0)), closes [#139](https://github.com/amannn/next-optimal-intl/issues/139)
* Prod release ([d4a0103](https://github.com/amannn/next-optimal-intl/commit/d4a0103bbbf71c3959ccde4e203301b5480c9cd7))
* Support `./i18n/request.ts` in addition to `./i18n.ts` ([#1308](https://github.com/amannn/next-optimal-intl/issues/1308)) ([258e95e](https://github.com/amannn/next-optimal-intl/commit/258e95ebef10033c3d6de524e6cd6c7459a18916))
* Support `numberingSystem` and `style` for relative time formatting ([#1057](https://github.com/amannn/next-optimal-intl/issues/1057)) ([14e3aa4](https://github.com/amannn/next-optimal-intl/commit/14e3aa4a4b04736ab8fcdcd50e6a57dd57bd08d7)), closes [#1056](https://github.com/amannn/next-optimal-intl/issues/1056)
* Support `trailingSlash: true` in Next.js config ([#1190](https://github.com/amannn/next-optimal-intl/issues/1190)) ([cfbdee9](https://github.com/amannn/next-optimal-intl/commit/cfbdee990b367a968eca6258d5c2fcfe8ef2ff2d))
* Support formatting of React elements via `format.list(…)`. ([#845](https://github.com/amannn/next-optimal-intl/issues/845)) ([7bf11d4](https://github.com/amannn/next-optimal-intl/commit/7bf11d42b26c66bcecaf69627e6bd1925d8ba49d))
* Support Next.js 11 ([#36](https://github.com/amannn/next-optimal-intl/issues/36)) ([fc59871](https://github.com/amannn/next-optimal-intl/commit/fc5987156c2a74a9703e39f2b7ee19b84165fd77))
* Support Next.js 12 ([#61](https://github.com/amannn/next-optimal-intl/issues/61)) ([0391cc8](https://github.com/amannn/next-optimal-intl/commit/0391cc85d3401bca9df29080a569957f6be93c85))
* Support Next.js 14 ([#593](https://github.com/amannn/next-optimal-intl/issues/593)) ([5c449f5](https://github.com/amannn/next-optimal-intl/commit/5c449f565f4ef3587555865d86775dd9c06b8a4d))
* Support providing a locale in `i18n.ts` instead of reading it from the pathname ([#1017](https://github.com/amannn/next-optimal-intl/issues/1017)) ([5c968b2](https://github.com/amannn/next-optimal-intl/commit/5c968b22bc3520cabc31bc3d6648e4f527c3404a))
* Support React 18 ([#98](https://github.com/amannn/next-optimal-intl/issues/98)) ([38614eb](https://github.com/amannn/next-optimal-intl/commit/38614eb9c6d6fb96704424d7f3ff8a67a24b789e))
* Support React 19 ([#1597](https://github.com/amannn/next-optimal-intl/issues/1597)) ([e0ffe29](https://github.com/amannn/next-optimal-intl/commit/e0ffe292a3cae8955fcd06bd8e8e2b02c525ef69))
* Support symbols in localized pathnames that require URL encoding ([#959](https://github.com/amannn/next-optimal-intl/issues/959)) ([b6e66f4](https://github.com/amannn/next-optimal-intl/commit/b6e66f4afd663ea5dc0851f5b528bcc55388b927)), closes [#607](https://github.com/amannn/next-optimal-intl/issues/607) [/github.com/amannn/next-intl/issues/607#issuecomment-1979747515](https://github.com/amannn//github.com/amannn/next-intl/issues/607/issues/issuecomment-1979747515)
* Sync improvements from RSC branch to main ([#238](https://github.com/amannn/next-optimal-intl/issues/238)) ([1d12ba2](https://github.com/amannn/next-optimal-intl/commit/1d12ba219afdbca77663c9d20f18db746de033fd)), closes [#149](https://github.com/amannn/next-optimal-intl/issues/149) [#237](https://github.com/amannn/next-optimal-intl/issues/237)
* Type safe messages ([#93](https://github.com/amannn/next-optimal-intl/issues/93)) ([13b49b1](https://github.com/amannn/next-optimal-intl/commit/13b49b138bc0ec3adbe661af6a70dfabfe7e86b0))
* TypeScript improvements: Use enum type for `style` of `NumberFormatOptions`, only allow passing React children to messages rendered with `t.rich` and update `tslib` ([#63](https://github.com/amannn/next-optimal-intl/issues/63)) ([d73e935](https://github.com/amannn/next-optimal-intl/commit/d73e9358bf13c87c0a653bd9fbed35e41548ff1d))
* When using localized pathnames, allow access to internal pathnames only if they match an entry from a particular locale—otherwise redirect ([#914](https://github.com/amannn/next-optimal-intl/issues/914)) ([0658600](https://github.com/amannn/next-optimal-intl/commit/0658600ee323350dfeb2d616c38f6737674e76da))

### Bug Fixes

* Accept `ref` for `next-intl/link` ([#300](https://github.com/amannn/next-optimal-intl/issues/300)) ([4d7cc17](https://github.com/amannn/next-optimal-intl/commit/4d7cc17de723c23fff81e2d77623f734a7cc9363)), closes [#299](https://github.com/amannn/next-optimal-intl/issues/299)
* Accept empty messages ([0a10ee6](https://github.com/amannn/next-optimal-intl/commit/0a10ee6d1d8ce270387c5a0a119993c665af41cc))
* Add error handling in case an invalid i18n request config file has been specified ([#1327](https://github.com/amannn/next-optimal-intl/issues/1327)) ([18b9fd6](https://github.com/amannn/next-optimal-intl/commit/18b9fd64af235c144cc0e5f4f166ba4df20fece4))
* Add missing deprecation warnings for `next-intl@4.0` ([#1485](https://github.com/amannn/next-optimal-intl/issues/1485)) ([1d60d08](https://github.com/amannn/next-optimal-intl/commit/1d60d08c446d9eeac8bcc5bfbd0654113a737518))
* Add workaround for OpenTelemetry/Zone.js ([#1719](https://github.com/amannn/next-optimal-intl/issues/1719)) ([1cac9a6](https://github.com/amannn/next-optimal-intl/commit/1cac9a65d2aefe20ff7fcf734e70f1fe85cac19d)), closes [#1711](https://github.com/amannn/next-optimal-intl/issues/1711)
* Allow to call `getRequestConfig` in outer module closure in a Client Component module graph ([#687](https://github.com/amannn/next-optimal-intl/issues/687)) ([0f16f10](https://github.com/amannn/next-optimal-intl/commit/0f16f106a68a2a443eb0ec3671084d40bf466d2f)), closes [#685](https://github.com/amannn/next-optimal-intl/issues/685)
* Allow to import `next-intl/link` into Server Components without having to add a wrapping Client Component ([#465](https://github.com/amannn/next-optimal-intl/issues/465)) ([21a0691](https://github.com/amannn/next-optimal-intl/commit/21a06913055028848d36474fe636a4e3e332f647))
* Allow to import `next-intl/server` into Client Components (however not call any functions). This allows for easier testing of page components with multiple exports. ([#683](https://github.com/amannn/next-optimal-intl/issues/683)) ([5ca4075](https://github.com/amannn/next-optimal-intl/commit/5ca4075e58c152e898e9048f3002c11c7aef2dd9)), closes [#681](https://github.com/amannn/next-optimal-intl/issues/681)
* Allow usage of `getTranslations({namespace})` without TypeScript integration for messages ([#630](https://github.com/amannn/next-optimal-intl/issues/630)) ([62cf29c](https://github.com/amannn/next-optimal-intl/commit/62cf29c978863cf65f62e34f739775901f0f6d8a)), closes [#625](https://github.com/amannn/next-optimal-intl/issues/625)
* Allow usage of `next-intl/link` and `usePathname` outside of Next.js ([#338](https://github.com/amannn/next-optimal-intl/issues/338)) ([6e1a56c](https://github.com/amannn/next-optimal-intl/commit/6e1a56c8c7b708b578033b41c31436a4dde32afc)), closes [#337](https://github.com/amannn/next-optimal-intl/issues/337)
* Allow usage outside of Next.js (e.g. Jest and Storybook) ([#76](https://github.com/amannn/next-optimal-intl/issues/76)) ([7c6925b](https://github.com/amannn/next-optimal-intl/commit/7c6925b39338be95c1c940c67a1ae2f5e3f85cdd))
* Apply `useMemo` for `useRouter` returned from `createLocalizedPathnamesNavigation` to keep a stable reference when possible ([#1201](https://github.com/amannn/next-optimal-intl/issues/1201)) ([a1b9a36](https://github.com/amannn/next-optimal-intl/commit/a1b9a3680b2a0d7f5b77f8571787ea8d66043852)), closes [#1198](https://github.com/amannn/next-optimal-intl/issues/1198)
* Apply correct port and protocol during domain-based redirects when called from an internal address (e.g. from a proxy) ([#662](https://github.com/amannn/next-optimal-intl/issues/662)) ([2bb867d](https://github.com/amannn/next-optimal-intl/commit/2bb867d1747123763a4e0144a99236ca3a8bc884)), closes [#658](https://github.com/amannn/next-optimal-intl/issues/658)
* Apply correct port when redirecting to another domain and the app doesn't run behind a proxy ([#979](https://github.com/amannn/next-optimal-intl/issues/979) by [@awkaiser-tr](https://github.com/awkaiser-tr)) ([485f59e](https://github.com/amannn/next-optimal-intl/commit/485f59e2c09224bf260e87ede30a67d0a5c542c0)), closes [#658](https://github.com/amannn/next-optimal-intl/issues/658)
* Automate versioning (internal change, publishing only for testing purposes) ([#30](https://github.com/amannn/next-optimal-intl/issues/30)) ([5888855](https://github.com/amannn/next-optimal-intl/commit/58888552861f95f3ecad6e69a52198a67c413aef))
* Bring back ESM build (and fix bundle size) ([#381](https://github.com/amannn/next-optimal-intl/issues/381)) ([4d0fefc](https://github.com/amannn/next-optimal-intl/commit/4d0fefcb558bcee6037dce7bd8cebe727257c8ca))
* Change `numeric` option from `auto` to `always` for `format.relativeTime` ([#765](https://github.com/amannn/next-optimal-intl/issues/765)) ([246d373](https://github.com/amannn/next-optimal-intl/commit/246d37320669c3525db03dc635b6cfcac8591b4a)), closes [#757](https://github.com/amannn/next-optimal-intl/issues/757)
* Clean up context errors ([97804dc](https://github.com/amannn/next-optimal-intl/commit/97804dca72dc393ee202b50988dbb0f903a48d2d))
* Correct version range ([ffbff8e](https://github.com/amannn/next-optimal-intl/commit/ffbff8ef6c028f61bf6d239dbc232e4a86cb452a))
* Correctly detect base path at the app root `/` when using a locale prefix strategy other than `always`. This ensures the locale cookie is set correctly. ([#999](https://github.com/amannn/next-optimal-intl/issues/999)) ([1ce5988](https://github.com/amannn/next-optimal-intl/commit/1ce598893281f9789046b639b39a55fe4cca34c7)), closes [#997](https://github.com/amannn/next-optimal-intl/issues/997)
* Correctly handle search params in redirects when using `trailingSlash: true` ([#1537](https://github.com/amannn/next-optimal-intl/issues/1537)) ([03a4620](https://github.com/amannn/next-optimal-intl/commit/03a4620432ff063b2b84f4dba5c49ae36b92fd73))
* Correctly normalize pathname for redirects and alternate links when `localePrefix: 'as-needed'` is used with the default locale ([#698](https://github.com/amannn/next-optimal-intl/issues/698) by [@anna-colenso](https://github.com/anna-colenso)) ([48e9523](https://github.com/amannn/next-optimal-intl/commit/48e9523863b99b363f63f0aa991c72860d814d7e))
* Correctly parse date skeleton `EEEE` to a long weekday like "Tuesday" (upgrades to `intl-messageformat@10` internally) ([#1039](https://github.com/amannn/next-optimal-intl/issues/1039)) ([d6b5fd2](https://github.com/amannn/next-optimal-intl/commit/d6b5fd2d882b26a47c596a56d687039ffea1baac))
* Deprecate `./i18n.ts` in favor of `./i18n/request.ts` ([0b8e3a5](https://github.com/amannn/next-optimal-intl/commit/0b8e3a5fc7ad19b8ef8866ec43ddf10766dfb3c4))
* Deprecate `createSharedPathnamesNavigation` and `createLocalizedPathnamesNavigation` in favor of `createNavigation` ([c5f7d7b](https://github.com/amannn/next-optimal-intl/commit/c5f7d7b47626adace248a454c3aa13d5da3f6429))
* Don't require `react-dom` as a peer dependency ([#39](https://github.com/amannn/next-optimal-intl/issues/39)) ([39edfcd](https://github.com/amannn/next-optimal-intl/commit/39edfcd9091e09570fc2152cda6a1e9ae5e7c210))
* Don't retrieve defaults for `locale`, `now` and `timeZone` if these options have been provided to `NextIntlClientProvider` ([#633](https://github.com/amannn/next-optimal-intl/issues/633)) ([824363a](https://github.com/amannn/next-optimal-intl/commit/824363a97d4cc735cb627349e7e16c80fd22b25a)), closes [#631](https://github.com/amannn/next-optimal-intl/issues/631)
* Don't set cookie on response if `localeDetection: false` ([#654](https://github.com/amannn/next-optimal-intl/issues/654)) ([e85149c](https://github.com/amannn/next-optimal-intl/commit/e85149cb27d9e036dda1712a03a152d5fe241986)), closes [#609](https://github.com/amannn/next-optimal-intl/issues/609)
* Don't warn when setting `prefetch={true}` on `<Link />` ([#1463](https://github.com/amannn/next-optimal-intl/issues/1463)) ([fd6d73d](https://github.com/amannn/next-optimal-intl/commit/fd6d73dc145a0679e85a1a71fe40c43d3312e27e)), closes [#1462](https://github.com/amannn/next-optimal-intl/issues/1462)
* Enable React Compiler ESLint plugin and fix relevant case ([#1281](https://github.com/amannn/next-optimal-intl/issues/1281)) ([606f4cc](https://github.com/amannn/next-optimal-intl/commit/606f4cc7bb821d685e3559dc674859fe13bb521a)), closes [/github.com/amannn/next-intl/pull/1281/files#diff-cc1535638f476a3c6bc0963bee2d96d868d36b3bfe54532f883bd68c8b6c7032](https://github.com/amannn//github.com/amannn/next-intl/pull/1281/files/issues/diff-cc1535638f476a3c6bc0963bee2d96d868d36b3bfe54532f883bd68c8b6c7032) [/github.com/amannn/next-intl/pull/1281/files#diff-77b8d7665f71fbfd5b235e11a40577295255c916dc2fa688c1538d3fa7aa85](https://github.com/amannn//github.com/amannn/next-intl/pull/1281/files/issues/diff-77b8d7665f71fbfd5b235e11a40577295255c916dc2fa688c1538d3fa7aa85)
* Enable tree-shaking ([#108](https://github.com/amannn/next-optimal-intl/issues/108)) ([157b0e2](https://github.com/amannn/next-optimal-intl/commit/157b0e28376055e7e34e86007c51d008c8e214aa))
* Export `DomainsConfig` ([#1175](https://github.com/amannn/next-optimal-intl/issues/1175)) ([c4d1bb0](https://github.com/amannn/next-optimal-intl/commit/c4d1bb08e23cc8a726c3a52e6cee7b1c63cb4c8a))
* Fix compatibility with `moduleResolution: 'Bundler'` ([#694](https://github.com/amannn/next-optimal-intl/issues/694)) ([f7425a5](https://github.com/amannn/next-optimal-intl/commit/f7425a54a1d35235ec84d2937006d43152cbbe16)), closes [#690](https://github.com/amannn/next-optimal-intl/issues/690)
* Fix ESM output of `use-intl` ([#754](https://github.com/amannn/next-optimal-intl/issues/754)) ([e73fb38](https://github.com/amannn/next-optimal-intl/commit/e73fb381c3f0eaeb15b3d9ab9aebc2c567c766ae))
* Fix forwarding of request headers in middleware ([#269](https://github.com/amannn/next-optimal-intl/issues/269) by @ARochniak) ([4ecbab5](https://github.com/amannn/next-optimal-intl/commit/4ecbab55c53d88a287a11237eea80bd66233f8c1)), closes [#266](https://github.com/amannn/next-optimal-intl/issues/266)
* Fix open redirect vulnerability for `localePrefix: 'as-necessary'` by sanitizing pathname in the middleware ([#1208](https://github.com/amannn/next-optimal-intl/issues/1208)) ([f42ac01](https://github.com/amannn/next-optimal-intl/commit/f42ac014c8a01124ab4eba46652a5224c5d7698e)), closes [#1207](https://github.com/amannn/next-optimal-intl/issues/1207)
* Fix support for older Next.js versions by moving `Link` to `next-intl/link` ([#288](https://github.com/amannn/next-optimal-intl/issues/288)) ([f26ef99](https://github.com/amannn/next-optimal-intl/commit/f26ef999bf92c142d56d0009259e5a224c5dec5b)), closes [#287](https://github.com/amannn/next-optimal-intl/issues/287)
* Fix types for passing a custom `type` to `redirect` ([#714](https://github.com/amannn/next-optimal-intl/issues/714)) ([db65cb7](https://github.com/amannn/next-optimal-intl/commit/db65cb7737a605bd8f2c69bf1b28cd076bf40fcf)), closes [#709](https://github.com/amannn/next-optimal-intl/issues/709)
* Follow-up for [#1573](https://github.com/amannn/next-optimal-intl/issues/1573) to also handle the case when a non-default locale is in use ([#1578](https://github.com/amannn/next-optimal-intl/issues/1578)) ([fd71741](https://github.com/amannn/next-optimal-intl/commit/fd7174179881a19e3573fceb9c6e903923644761)), closes [#1568](https://github.com/amannn/next-optimal-intl/issues/1568)
* Forward optional remaining args from Next.js router to wrapped `useRouter` ([3ff878c](https://github.com/amannn/next-optimal-intl/commit/3ff878c380d998171fbc777df1951d1c817ab9ad))
* Handle `localeCookie` setting correctly on client side ([#1417](https://github.com/amannn/next-optimal-intl/issues/1417)) ([13ee366](https://github.com/amannn/next-optimal-intl/commit/13ee36630ddbfd04f85e0041ff87f0856e504b2b))
* Handle `query` in `<Link />` correctly when using `localePrefix: 'as-needed'` with `domains` ([#1732](https://github.com/amannn/next-optimal-intl/issues/1732)) ([ec8776e](https://github.com/amannn/next-optimal-intl/commit/ec8776e8f0344f78fea4f71284c48312484a7059)), closes [#1731](https://github.com/amannn/next-optimal-intl/issues/1731)
* Handle case where the `locale` param is an array and set cookie expiration to one year ([#435](https://github.com/amannn/next-optimal-intl/issues/435)) ([82e842c](https://github.com/amannn/next-optimal-intl/commit/82e842ce742106bf350246316855bd053f4cdac7))
* Handle changing href for `<Link />` correctly when using `localePrefix: 'never'` ([#926](https://github.com/amannn/next-optimal-intl/issues/926)) ([b609dc0](https://github.com/amannn/next-optimal-intl/commit/b609dc05b31832af04ee57b73133568e43b69d1f)), closes [#918](https://github.com/amannn/next-optimal-intl/issues/918)
* Handle external URLs passed to `redirect` and `permanentRedirect` ([#1084](https://github.com/amannn/next-optimal-intl/issues/1084) by [@mhogeveen](https://github.com/mhogeveen)) ([16b55e2](https://github.com/amannn/next-optimal-intl/commit/16b55e255cb70e76c07a9399205102ed4e26361d))
* Handle inconsistency in Next.js when using `usePathname` with custom prefixes, `localePrefix: 'as-needed'` and static rendering ([#1573](https://github.com/amannn/next-optimal-intl/issues/1573)) ([20fd0f0](https://github.com/amannn/next-optimal-intl/commit/20fd0f0015839357893bcd256ff880a98b01ea1f))
* Handle inlined search params and hashes correctly in `<Link />` from `createNavigation` ([#1448](https://github.com/amannn/next-optimal-intl/issues/1448)) ([ba0a537](https://github.com/amannn/next-optimal-intl/commit/ba0a537571b49d2d31cbc3c5079a7ad738e1409b))
* Handle malformed pathnames in middleware ([#1353](https://github.com/amannn/next-optimal-intl/issues/1353)) ([dcda9d9](https://github.com/amannn/next-optimal-intl/commit/dcda9d9c851046bd3032f6841b10831b50937ebb)), closes [#1351](https://github.com/amannn/next-optimal-intl/issues/1351)
* Handle optional catch-all segments in navigation APIs if no value is provided and handle the case if a dynamic value appears multiple times in a pathname ([#1259](https://github.com/amannn/next-optimal-intl/issues/1259)) ([58ef482](https://github.com/amannn/next-optimal-intl/commit/58ef482eda383fc03a552a4f34b00c7b3136a4af)), closes [#1236](https://github.com/amannn/next-optimal-intl/issues/1236)
* Handle optional params in catch-all segments correctly when using localized pathnames ([#925](https://github.com/amannn/next-optimal-intl/issues/925)) ([8ba8b69](https://github.com/amannn/next-optimal-intl/commit/8ba8b699b5343a816f725d329fdb1153fa647b99)), closes [#917](https://github.com/amannn/next-optimal-intl/issues/917)
* Handle overlapping custom locale prefixes correctly ([#1343](https://github.com/amannn/next-optimal-intl/issues/1343)) ([72c1731](https://github.com/amannn/next-optimal-intl/commit/72c1731892db6e7d0470cefcea2b1f22a5f37ce2)), closes [#1329](https://github.com/amannn/next-optimal-intl/issues/1329)
* Handle overlapping locale prefixes correctly pt. 2 ([#1344](https://github.com/amannn/next-optimal-intl/issues/1344)) ([7958659](https://github.com/amannn/next-optimal-intl/commit/7958659f858bb5df19203ec3c1a8701e029ed2c4))
* Improve error message when encountering a missing message in production ([#706](https://github.com/amannn/next-optimal-intl/issues/706)) ([515891b](https://github.com/amannn/next-optimal-intl/commit/515891b539c723778d2a5a2e6c0186bb6f916071))
* Improve error message when trying to use `next-intl` APIs in RSC ([#267](https://github.com/amannn/next-optimal-intl/issues/267)) ([0f46176](https://github.com/amannn/next-optimal-intl/commit/0f461760fa84b6daa29ad156b99650e0d44f22d4))
* Improve performance when calling hooks like `useTranslations` in Server Components by making sure we only suspend when i18n config is initially loaded and never for subsequent calls ([#741](https://github.com/amannn/next-optimal-intl/issues/741)) ([4185a72](https://github.com/amannn/next-optimal-intl/commit/4185a72525581dcd04f2646af00a0e330f8e02e0))
* Improve RSC render performance by sharing a cache between `getTranslations` and `useTranslations` ([#798](https://github.com/amannn/next-optimal-intl/issues/798) by [@fkapsahili](https://github.com/fkapsahili)) ([73e8337](https://github.com/amannn/next-optimal-intl/commit/73e8337044a8cb187d6f96f9b5ea77f6252866bb))
* Improve support for older browsers by switching from `replaceAll` to `replace` ([#885](https://github.com/amannn/next-optimal-intl/issues/885) by @MichalMoravik) ([080333a](https://github.com/amannn/next-optimal-intl/commit/080333aa8ec2e4e41dc740e370032ee429b190f0)), closes [#884](https://github.com/amannn/next-optimal-intl/issues/884)
* Incorporate `basePath` correctly in `useRouter` functions ([#906](https://github.com/amannn/next-optimal-intl/issues/906)) ([4abcbeb](https://github.com/amannn/next-optimal-intl/commit/4abcbebdd603a18d9f1173709c174a8ac4210e37)), closes [#905](https://github.com/amannn/next-optimal-intl/issues/905) [#910](https://github.com/amannn/next-optimal-intl/issues/910)
* Keep cookie value in sync when navigating within a locale ([#828](https://github.com/amannn/next-optimal-intl/issues/828)) ([1167523](https://github.com/amannn/next-optimal-intl/commit/1167523f01ed6363c3fe3bbb7aa925744eedd055)), closes [#826](https://github.com/amannn/next-optimal-intl/issues/826)
* Lazy init message formatter for improved tree shaking in case `useTranslations` is only used in Server Components ([#1279](https://github.com/amannn/next-optimal-intl/issues/1279)) ([9f1725c](https://github.com/amannn/next-optimal-intl/commit/9f1725c20b8c542e46f197c2afa2b066e1293a7a))
* Make all keys of `Formats` type optional for easier usage ([#1367](https://github.com/amannn/next-optimal-intl/issues/1367)) ([a7cbd9b](https://github.com/amannn/next-optimal-intl/commit/a7cbd9bb1d42aacb17e7a5500b7054c8bc76799b))
* Make sure cookie value stays up to date when the Next.js Router Cache is used ([#790](https://github.com/amannn/next-optimal-intl/issues/790)) ([977b973](https://github.com/amannn/next-optimal-intl/commit/977b9732aa7b0a9cb0c26e8cf34ae30cc96f25b6)), closes [#786](https://github.com/amannn/next-optimal-intl/issues/786) [#786](https://github.com/amannn/next-optimal-intl/issues/786)
* Move JSDoc for `next/link` ([b85b6f5](https://github.com/amannn/next-optimal-intl/commit/b85b6f53fc541f4832a750665060b40839574533))
* Prefer `locale` from `NextIntlClientProvider` when using `useLocale` in Client Components. `useParams().locale` is still used as a fallback. ([#691](https://github.com/amannn/next-optimal-intl/issues/691)) ([e00ed97](https://github.com/amannn/next-optimal-intl/commit/e00ed97746dc8d6c264b2f4aa9162681c1a89919)), closes [#688](https://github.com/amannn/next-optimal-intl/issues/688)
* Prefer more specific routes in `usePathname` when detecting the currently active pathname for localized pathnames ([#1152](https://github.com/amannn/next-optimal-intl/issues/1152)) ([936839e](https://github.com/amannn/next-optimal-intl/commit/936839e9508e447f3e60cc1f606258fd00e5227e)), closes [#1151](https://github.com/amannn/next-optimal-intl/issues/1151)
* Print a warning in case the middleware didn't run on a request but APIs from `next-intl` are used ([#1045](https://github.com/amannn/next-optimal-intl/issues/1045)) ([8149955](https://github.com/amannn/next-optimal-intl/commit/814995511a81edf1d8c5ef843873fff003d2782e))
* Print warning for inconsistent i18n setup where no `locale` is read in `getRequestConfig` and also none is returned ([#1305](https://github.com/amannn/next-optimal-intl/issues/1305)) ([2f0f781](https://github.com/amannn/next-optimal-intl/commit/2f0f78142d32c2ffa32493c52f270eb4ed3f1a49))
* Remove `@formatjs/ecma402-abstract` dependency in favor of the automatically bundled one from `intl-messageformat` ([300ceee](https://github.com/amannn/next-optimal-intl/commit/300ceeef3800b9ece12e9dca928130cafee5c64a))
* Remove `@formatjs/ecma402-abstract` dependency in favor of the automatically bundled one from `intl-messageformat` ([#1141](https://github.com/amannn/next-optimal-intl/issues/1141)) ([8b2a656](https://github.com/amannn/next-optimal-intl/commit/8b2a656320a0712aa44676cdf967e53a1000c6f8))
* Remove `x-default` alternate links entry for non-root pathnames when using `localePrefix: 'always'`  ([#805](https://github.com/amannn/next-optimal-intl/issues/805)) ([c5bb0f5](https://github.com/amannn/next-optimal-intl/commit/c5bb0f50efbb5321181439c6d9e9aee08226b46a))
* Remove ESM build ([#379](https://github.com/amannn/next-optimal-intl/issues/379)) ([22d9f27](https://github.com/amannn/next-optimal-intl/commit/22d9f272a06b99b1d1f9f3079b44067b8349102b))
* Remove usage of deprecated `ReactNodeArray` which is removed in React 19 ([#1445](https://github.com/amannn/next-optimal-intl/issues/1445)) ([2396345](https://github.com/amannn/next-optimal-intl/commit/23963458e3ef3d5d29eeb9df01f40bbe11245301))
* Resolve locale for navigation APIs consistently from `i18n/request.ts` in `react-server` like all other APIs do ([#1459](https://github.com/amannn/next-optimal-intl/issues/1459)) ([8c6d5ff](https://github.com/amannn/next-optimal-intl/commit/8c6d5fff009ac3c54b2847c23b8148759d0b6ffa))
* Set `SameSite` attribute for locale cookie to `strict` ([#302](https://github.com/amannn/next-optimal-intl/issues/302)) ([0a6bce5](https://github.com/amannn/next-optimal-intl/commit/0a6bce5d57733487b99a7da5037c6195b9d2779b)), closes [#301](https://github.com/amannn/next-optimal-intl/issues/301)
* Set cookie to `SameSite: Lax` ([#817](https://github.com/amannn/next-optimal-intl/issues/817)) ([0e91e64](https://github.com/amannn/next-optimal-intl/commit/0e91e64412f919f70533c9d6189073780a5baae8)), closes [#527](https://github.com/amannn/next-optimal-intl/issues/527) [#811](https://github.com/amannn/next-optimal-intl/issues/811)
* Support `t.has` when `getTranslations` is called with an object argument ([#1616](https://github.com/amannn/next-optimal-intl/issues/1616)) ([64895a2](https://github.com/amannn/next-optimal-intl/commit/64895a2bb3c445f6e3deab85152a0d04ced17e46)), closes [/github.com/amannn/next-intl/discussions/437#discussioncomment-11593318](https://github.com/amannn//github.com/amannn/next-intl/discussions/437/issues/discussioncomment-11593318)
* Support relative pathnames in `redirect` ([#1178](https://github.com/amannn/next-optimal-intl/issues/1178)) ([3b698d7](https://github.com/amannn/next-optimal-intl/commit/3b698d7abdb8859a43448381ba2361dee4b5e669)), closes [#1177](https://github.com/amannn/next-optimal-intl/issues/1177)
* Update `@formatjs/intl-localematcher` to latest version ([#1140](https://github.com/amannn/next-optimal-intl/issues/1140)) ([c217582](https://github.com/amannn/next-optimal-intl/commit/c217582cf47a3d0d65315e70eb9fd945efca7163))
* Update link to migration example in error messages ([#648](https://github.com/amannn/next-optimal-intl/issues/648) by [@outloudvi](https://github.com/outloudvi)) ([1f3b226](https://github.com/amannn/next-optimal-intl/commit/1f3b22672938dbc8421c918ed11438eca5436a32))
* Upgrade to `negotiator@^1.0` ([#1460](https://github.com/amannn/next-optimal-intl/issues/1460)) ([b93f297](https://github.com/amannn/next-optimal-intl/commit/b93f29736250a749333d438b06b7a608e9d73c28))
* Use correct host and protocol for alternate links when running behind a proxy (`x-forwarded-host`, `x-forwarded-proto`) ([#462](https://github.com/amannn/next-optimal-intl/issues/462) by @HHongSeungWoo) ([747cf8e](https://github.com/amannn/next-optimal-intl/commit/747cf8ef71a2e27a39c2178353eb31cfda8170f2))
* Use correct port for alternate links when running behind a proxy ([#514](https://github.com/amannn/next-optimal-intl/issues/514) by [@iza-w](https://github.com/iza-w)) ([747ad5b](https://github.com/amannn/next-optimal-intl/commit/747ad5b38301499e8857be6eae6540257623752c))
* Use correct version range for use-intl ([02c33d3](https://github.com/amannn/next-optimal-intl/commit/02c33d341794bdcf6ba30ca8325a6a843a684635))
* Use ESM build only for browser bundlers (not Node.js) ([#386](https://github.com/amannn/next-optimal-intl/issues/386)) ([34a69f2](https://github.com/amannn/next-optimal-intl/commit/34a69f29cf07032c8a02aaf2b94e7e60d3f35088))
* Use new domain `next-intl.dev` in links ([#1601](https://github.com/amannn/next-optimal-intl/issues/1601)) ([40a9a77](https://github.com/amannn/next-optimal-intl/commit/40a9a7722edc8e7787ed799a4bf1d3c4a2e04848))
* When using `domains` in routing config, handle unknown domains like `localhost:3000` more gracefully in middleware ([#1389](https://github.com/amannn/next-optimal-intl/issues/1389)) ([2fb56b1](https://github.com/amannn/next-optimal-intl/commit/2fb56b1cc60d5cc88a98c12bf74a3d21588f18dd))
* When using domain-based routing, use `defaultLocale` of a domain instead of the top-level one in case no other locale matches better on the domain ([#1000](https://github.com/amannn/next-optimal-intl/issues/1000)) ([42988b7](https://github.com/amannn/next-optimal-intl/commit/42988b773581dad7a09af0b5cd01c958afa60865)), closes [#998](https://github.com/amannn/next-optimal-intl/issues/998)
